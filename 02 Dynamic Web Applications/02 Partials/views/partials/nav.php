      ...
      <div class="flex items-center">
        ...
        <div class="hidden md:block">
          <div class="ml-10 flex items-baseline space-x-4">
            ...
            <a href="/" aria-current="page" class="rounded-md bg-gray-950/50 text-white  px-3 py-2 text-sm font-medium text-white">Home</a>
            <a href="/team.php" class="rounded-md text-gray-300 hover:bg-white/5 hover:text-white  px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">Team</a>
            <a href="/projects.php" class="rounded-md text-gray-300 hover:bg-white/5 hover:text-white  px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">Projects</a>
            <a href="/about.php" class="rounded-md text-gray-300 hover:bg-white/5 hover:text-white  px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">About</a>
            <a href="/contact.php" class="rounded-md text-gray-300 hover:bg-white/5 hover:text-white  px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">Contact</a>
          </div>
        </div>
      </div>
      <div class="hidden md:block">

...
<main>
    <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
        ...
        <!-- <a href="/notes" class="inline-block mb-6 px-4 py-2 hover:text-blue-600">Delete Note</a>  //this not work because it's a get request -->

        <form method="POST"action="/note" >
            <input type="hidden" name="_method" value="DELETE">
        <input type="hidden" name="id" value="<?= $note['id'] ?>">
            <button type="submit" class="mt-4 inline-block px-4 py-2 bg-red-600 text-white rounded hover:bg-red-700">Delete Note</button>
        </form>
